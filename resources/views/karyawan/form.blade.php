            ...
            <div class="card-body">
                ...
                <form action="{{$url}}" method="post" id="form">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" value="1" name="{{$name[15]}}">
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <input type="hidden" name="{{$name[19]}}" value="1">
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">                   
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$cuti->nilai}}" class="form-control @error($name[29]) is-invalid @enderror"
                        ...
                        <div class="modal-dialog modal-md" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Silakan pilih tanggal shift karyawan yang ini dimasukkan. untuk cek shift grup karyawan, cek di <a href="{{url('atur-shift-grup-karyawan/')}}">Atur Shift Grup Karyawan</a>.</p>
...
<script>
    ...
    $('#submit').click(function(e){
        let id_grup_karyawan = $('select[name="id_grup_karyawan"]').val();

        $.ajax({
            url: "{{url('karyawan/cek-shift')}}",
            type: "POST",
            data:  {
