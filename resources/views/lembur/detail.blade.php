                ...
                <form id="form" action="{{url('/lembur/update-lembur')}}" method="POST">
                  ...
                  @foreach($data->data_lembur as $data)
                    <div class="sub-content">
                      <div class="row">
                          <div class="col-4">
                              <input type="text" class="form-control numeric" name="index_tarif[]" value="{{$data['index_tarif']}}" readonly>
                          </div>
                          <div class="col-4">
                              <input type="text" class="form-control numeric" name="jumlah_jam[]" value="{{$data['jumlah_jam']}}" readonly>
                          </div>
                          <div class="col-4">
                              <input type="button" class="btn btn-danger hapus" value="Hapus" disabled>
                          </div>
                      </div><br>
                    </div>
                  @endforeach
                  ...
                  <hr><br>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="alasan" id="exampleFormControlTextarea1" rows="3" readonly>{{$alasan}}</textarea>
                    </div>
                  <div class="row">
                      <div class="col-4">
                          <input type="button" class="btn btn-info" value="@lang('umum.tambah')" id="btn-tambah" disabled>
                      </div>
                      <div class="col-8 text-right">
                          <input type="submit" class="btn btn-success" value="@lang('umum.simpan')" disabled>
                      </div>
                  </div><br>
                </form>
            </div>
